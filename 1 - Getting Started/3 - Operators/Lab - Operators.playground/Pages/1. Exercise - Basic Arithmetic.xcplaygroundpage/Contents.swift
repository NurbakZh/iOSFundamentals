...
//output is in double format, including numbers after the dot
/*:
...
let odd = 21
print(odd%2)
//reminder of even number dividing by 2 is always 0, and reminder of odd number dividing by 2 is always 1
/*:
