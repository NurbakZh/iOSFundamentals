...
var Nurbek = User(name: "Nurbek", age: 21, height: 164.5, weight: 56.1, activityLevel: 0)
print("Users name is \(Nurbek.name). He is \(Nurbek.age) years old, his height is \(Nurbek.height) and weights is \(Nurbek.weight) and activity level is \(Nurbek.activityLevel)")
/*:
...
var nurmile = Distance(feet: 400)
print(nurmile.feet)
print(nurmile.meters)
/*:
