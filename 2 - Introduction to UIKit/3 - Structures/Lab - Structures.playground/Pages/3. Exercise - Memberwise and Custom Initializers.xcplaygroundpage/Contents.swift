...
var favoriteBook = Book(title: "Nr", author: "Nurba", pages: 4, price: 400)
print("my fav book is \(favoriteBook.title) by \(favoriteBook.author), which has \(favoriteBook.pages) page and costs \(favoriteBook.price) tenge")
/*:
...
struct Laptop {
    ...
    var yearPurcgased: Int
    
}

var laptop1 = Laptop(yearPurcgased: 2000)
var laptop2 = Laptop(yearPurcgased: 2002)
...
var myHeight = Height(heightInCentimeters: 165)
