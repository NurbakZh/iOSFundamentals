...
//print(falcon.weapon)
print("First of all, I didn't create falcon instance in this page, however even if I have done it, we still can not print weapon of a falcon, because it is instance of a superClass - Spaceship and doesn't have this property")
