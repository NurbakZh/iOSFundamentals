...
func checkAge(someAge: String) -> Int?{
    if let someAge1 = Int(someAge) {
        if(someAge1<18) {
            print("Sorry,but you arem't old enough to use our app")
        } else {
            print("Welcome!")
        }
    } else {
...
checkAge(someAge: userInputAge)
checkAge(someAge: "34")
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
print(checkAge(someAge: userInputAge))
print(checkAge(someAge: "34")!)
...
print(purch(name: "Chips")!)
print(purch(name: "Donuts"))
print(purch(name: "People"))
