...
//print("The value of foo is \(foo)")
//because foo is initialized inside of the loop scope, and doesn't have any value
...
//because x is initialized before the loop scope and has value. It is modified in for loop.
